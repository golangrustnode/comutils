...
3. 其它则默认忽略
*/
func (e *Exec) Execute(cmds string, cmdType int64, timeOut int64) (res []byte, err error) {
	res, err = nil, nil
	defer func() {
	...
	switch cmdType {
	case 1:
		res, err = e.ExecSync(cmds, timeOut)
	case 2:
		res, err = e.ExecAsync(cmds)
	}
	return
}
...
命令异步执行，不需要超时时间
*/
func (e *Exec) ExecAsync(cmds string) ([]byte, error) {
...
func (e *Exec) ExecSync(cmds string, timeoutSec int64) ([]byte, error) {
	cmd := exec.Command("sh", "-c", cmds)
